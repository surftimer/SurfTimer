...
CREATE TABLE IF NOT EXISTS ck_checkpointsnew (
    steamid VARCHAR(32),
    mapname VARCHAR(32),
    cp1 DECIMAL(12, 6) DEFAULT '0.0',
    cp2 DECIMAL(12, 6) DEFAULT '0.0',
    cp3 DECIMAL(12, 6) DEFAULT '0.0',
    cp4 DECIMAL(12, 6) DEFAULT '0.0',
    cp5 DECIMAL(12, 6) DEFAULT '0.0',
    cp6 DECIMAL(12, 6) DEFAULT '0.0',
    cp7 DECIMAL(12, 6) DEFAULT '0.0',
    cp8 DECIMAL(12, 6) DEFAULT '0.0',
    cp9 DECIMAL(12, 6) DEFAULT '0.0',
    cp10 DECIMAL(12, 6) DEFAULT '0.0',
    cp11 DECIMAL(12, 6) DEFAULT '0.0',
    cp12 DECIMAL(12, 6) DEFAULT '0.0',
    cp13 DECIMAL(12, 6) DEFAULT '0.0',
    cp14 DECIMAL(12, 6) DEFAULT '0.0',
    cp15 DECIMAL(12, 6) DEFAULT '0.0',
    cp16 DECIMAL(12, 6) DEFAULT '0.0',
    cp17 DECIMAL(12, 6) DEFAULT '0.0',
    cp18 DECIMAL(12, 6) DEFAULT '0.0',
    cp19 DECIMAL(12, 6) DEFAULT '0.0',
    cp20 DECIMAL(12, 6) DEFAULT '0.0',
    cp21 DECIMAL(12, 6) DEFAULT '0.0',
    cp22 DECIMAL(12, 6) DEFAULT '0.0',
    cp23 DECIMAL(12, 6) DEFAULT '0.0',
    cp24 DECIMAL(12, 6) DEFAULT '0.0',
    cp25 DECIMAL(12, 6) DEFAULT '0.0',
    cp26 DECIMAL(12, 6) DEFAULT '0.0',
    cp27 DECIMAL(12, 6) DEFAULT '0.0',
    cp28 DECIMAL(12, 6) DEFAULT '0.0',
    cp29 DECIMAL(12, 6) DEFAULT '0.0',
    cp30 DECIMAL(12, 6) DEFAULT '0.0',
    cp31 DECIMAL(12, 6) DEFAULT '0.0',
    cp32 DECIMAL(12, 6) DEFAULT '0.0',
    cp33 DECIMAL(12, 6) DEFAULT '0.0',
    cp34 DECIMAL(12, 6) DEFAULT '0.0',
    cp35 DECIMAL(12, 6) DEFAULT '0.0',
