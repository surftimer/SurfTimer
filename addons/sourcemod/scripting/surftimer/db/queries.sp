...
char sql_insertCheckpoints[] = "INSERT INTO ck_checkpoints VALUES ('%s', '%s', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%i', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f')";
...
char sql_selectRecordCheckpointSpeeds[] = "SELECT zonegroup, cp1speed, cp2speed, cp3speed, cp4speed, cp5speed, cp6speed, cp7speed, cp8speed, cp9speed, cp10speed, cp11speed, cp12speed, cp13speed, cp14speed, cp15speed, cp16speed, cp17speed, cp18speed, cp19speed, cp20speed, cp21speed, cp22speed, cp23speed, cp24speed, cp25speed, cp26speed, cp27speed, cp28speed, cp29speed, cp30speed, cp31speed, cp32speed, cp33speed, cp34speed, cp35speed FROM ck_checkpoints WHERE mapname = '%s' AND steamid = (SELECT steamid FROM ck_playertimes WHERE mapname = '%s' ORDER BY runtimepro LIMIT 1);";
char sql_selectRecordCheckpoints[] = "SELECT zonegroup, cp1, cp2, cp3, cp4, cp5, cp6, cp7, cp8, cp9, cp10, cp11, cp12, cp13, cp14, cp15, cp16, cp17, cp18, cp19, cp20, cp21, cp22, cp23, cp24, cp25, cp26, cp27, cp28, cp29, cp30, cp31, cp32, cp33, cp34, cp35 FROM ck_checkpoints WHERE mapname = '%s' AND steamid = (SELECT steamid FROM ck_playertimes WHERE mapname = '%s' ORDER BY runtimepro LIMIT 1);";
char sql_deleteCheckpoints[] = "DELETE FROM ck_checkpoints WHERE mapname = '%s'";
//TO IMPLEMENT CP SPEEDS WITH PB THERE NEEDS TO BE A QUERY like char sql_selectCheckpointSpeeds[] and char sql_selectCheckpointSpeedsinZoneGroup[]
