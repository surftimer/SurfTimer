...
char sql_createBonusIndex[] = "ALTER TABLE ck_bonus ADD INDEX bonusrank (mapname,runtime,zonegroup,style);";
...
char sql_selectFastestBonus[] = "SELECT name, MIN(runtime), zonegroup, style, velStartXY, velStartXYZ, velStartZ, velEndXY, velEndXYZ, velEndZ FROM ck_bonus WHERE mapname = '%s' GROUP BY name, zonegroup, style, velStartXY, velStartXYZ, velStartZ, velEndXY, velEndXYZ, velEndZ;";
...
// ck_playeroptions2
char sql_createPlayerOptions[] = "CREATE TABLE IF NOT EXISTS `ck_playeroptions2` (`steamid` varchar(32) NOT NULL DEFAULT '', `timer` int(11) NOT NULL DEFAULT '1', `hide` int(11) NOT NULL DEFAULT '0', `sounds` int(11) NOT NULL DEFAULT '1', `chat` int(11) NOT NULL DEFAULT '0', `viewmodel` int(11) NOT NULL DEFAULT '1', `autobhop` int(11) NOT NULL DEFAULT '1', `checkpoints` int(11) NOT NULL DEFAULT '1', `gradient` int(11) NOT NULL DEFAULT '3', `speedmode` int(11) NOT NULL DEFAULT '0', `centrespeed` int(11) NOT NULL DEFAULT '0', `centrehud` int(11) NOT NULL DEFAULT '1', teleside int(11) NOT NULL DEFAULT '0', `velcmphud` INT NOT NULL DEFAULT 1, `velcmpchat` INT NOT NULL DEFAULT 1, `module1c` int(11) NOT NULL DEFAULT '1', `module2c` int(11) NOT NULL DEFAULT '2', `module3c` int(11) NOT NULL DEFAULT '3', `module4c` int(11) NOT NULL DEFAULT '4', `module5c` int(11) NOT NULL DEFAULT '5', `module6c` int(11) NOT NULL DEFAULT '6', `sidehud` int(11) NOT NULL DEFAULT '1', `module1s` int(11) NOT NULL DEFAULT '5', `module2s` int(11) NOT NULL DEFAULT '0', `module3s` int(11) NOT NULL DEFAULT '0', `module4s` int(11) NOT NULL DEFAULT '0', `module5s` int(11) NOT NULL DEFAULT '0', prestrafe int(11) NOT NULL DEFAULT '0', cpmessages int(11) NOT NULL DEFAULT '1', wrcpmessages int(11) NOT NULL DEFAULT '1', PRIMARY KEY (`steamid`)) DEFAULT CHARSET=utf8mb4;";
...
char sql_UpdateLastSeen[] = "UPDATE ck_playerrank SET lastseen = UNIX_TIMESTAMP() where steamid = '%s';";
...
char sql_selectMapRecord[] = "SELECT MIN(runtimepro), name, steamid, velStartXY, velStartXYZ, velStartZ, velEndXY, velEndXYZ, velEndZ, style FROM ck_playertimes WHERE mapname = '%s' AND runtimepro > -1.0 GROUP BY name, steamid, style;";
...
// ck_wrcps
char sql_createWrcps[] = "CREATE TABLE IF NOT EXISTS `ck_wrcps` (`steamid` varchar(32) NOT NULL DEFAULT '', `name` varchar(32) DEFAULT NULL, `mapname` varchar(32) NOT NULL DEFAULT '', `runtimepro` float NOT NULL DEFAULT '-1', `velStartXY` INT NOT NULL, `velStartXYZ` INT NOT NULL, `velStartZ` INT NOT NULL, `velEndXY` INT NOT NULL, `velEndXYZ` INT NOT NULL, `velEndZ` INT NOT NULL, `stage` int(11) NOT NULL, `style` int(11) NOT NULL DEFAULT '0', PRIMARY KEY (`steamid`,`mapname`,`stage`,`style`), KEY `stagerank` (`mapname`,`runtimepro`,`stage`,`style`)) DEFAULT CHARSET=utf8mb4;";
char sql_insertNewWrcp[] = "INSERT INTO ck_wrcps (steamid, name, mapname, runtimepro, stage, velStartXY, velStartXYZ, velStartZ, velEndXY, velEndXYZ, velEndZ) VALUES ('%s', '%s', '%s', '%f', %i, %i, %i, %i, %i, %i, %i);";
char sql_insertNewWrcpStyle[] = "INSERT INTO ck_wrcps (steamid, name, mapname, runtimepro, stage, style, velStartXY, velStartXYZ, velStartZ, velEndXY, velEndXYZ, velEndZ) VALUES ('%s', '%s', '%s', '%f', %i, %i, %i, %i, %i, %i, %i, %i);";
char sql_updateWrcp[] = "UPDATE ck_wrcps SET name = '%s', runtimepro = '%f', velStartXY = %i, velStartXYZ = %i, velStartZ = %i, velEndXY = %i, velEndXYZ = %i, velEndZ = %i WHERE steamid = '%s' AND mapname = '%s' AND stage = %i AND style = 0;";
char sql_updateWrcpStyle[] = "UPDATE ck_wrcps SET name = '%s', runtimepro = '%f', velStartXY = %i, velStartXYZ = %i, velStartZ = %i, velEndXY = %i, velEndXYZ = %i, velEndZ = %i WHERE steamid = '%s' AND mapname = '%s' AND stage = %i AND style = '%i';";
