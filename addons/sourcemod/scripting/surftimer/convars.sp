...
ConVar g_iTipsInterval = null;									// Time between two tips. 0 = off
ConVar g_bTipsRandomOrder = null;								// If tips are in random order
...
void CreateConVars()
{
	...
	g_iTipsInterval = AutoExecConfig_CreateConVar("ck_tips_interval", "300", "Seconds between two tips. Leave empty or set to 0 to disable", FCVAR_NOTIFY, true, 0.0, false);
	g_bTipsRandomOrder = AutoExecConfig_CreateConVar("ck_tips_random_order", "1", "(1 / 0) Enable/Disable tips shown in a random order", FCVAR_NOTIFY, true, 0.0, true, 1.0);
