...
void CreateConVars()
{
	...
	g_iHintsInterval = AutoExecConfig_CreateConVar("ck_hints_interval", "300", "Seconds between two hints. Leave empty or set to 0 to disable", FCVAR_NOTIFY, true, 0.0, false);
