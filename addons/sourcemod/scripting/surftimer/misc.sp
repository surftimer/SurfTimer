...
public void CheckRun(int client)
{
	...
	{
		if (g_fCurrentRunTime[client] > g_fPersonalRecord[client] && g_iCurrentStyle[client] == 0 && !g_bMissedMapBest[client] && !g_bPause[client] && g_iClientInZone[client][2] == 0)
		{
		...
		if (g_fCurrentRunTime[client] > g_fPersonalRecordBonus[g_iClientInZone[client][2]][client] && g_iCurrentStyle[client] == 0 && g_iClientInZone[client][2] > 0 && !g_bPause[client] && !g_bMissedBonusBest[client])
		{
