...
{
	if (client >= 1 && client <= MaxClients && IsValidEntity(client) && IsClientConnected(client) && IsClientInGame(client) && client != g_RecordBot && client != g_BonusBot && client != g_WrcpBot)
		return true;
	return false;
}
